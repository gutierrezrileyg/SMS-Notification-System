...
def main():
    ...
    api_secret_key = "sk__9lLevZsmYGbjuQ-76HRgBBQLPoOgS97AfeleU2xf_qk-hcY9T1ND069ZOtllOzsH8J78t6sUzcFxHNL4AbMjA-1646"

    message_content = (
        "Hello, magkano po 50 kilo ng bigas? Salamat po."
    )
